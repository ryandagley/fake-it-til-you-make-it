def what_is_X_percent_of_Y():
    ...
    print(str(progress/total*100) + " percent of " +
          str(total) + " is " + (str(progress)))
...
def X_is_what_percent_of_Y():
    ...
    print(str(progress) + " is " + str(progress /
          total*100) + " percent of " + str(total))
...
def add_percentage_to_X():
    ...
    percentage_increase = int(
        input("What percentage are you adding to " + str(start_value) + "? "))
...
def subtract_percentage_from_X():
    ...
    percentage_decrease = int(
        input("What percentage are you subtracting from " + str(start_value) + "? "))
...
def pareto():
    ...
    print(str(eighty) + "/" + str(twenty) + ".  80% of " + str(start_value) + " is " +
          str(eighty) + ".  20% of " + str(start_value) + " is " + str(twenty) + ".")
